...
const WIFI_FIRMWARE: &[u8; 230_321] = include_bytes!("../firmware/43439A0.bin");
const WIFI_CLM: &[u8; 4752] = include_bytes!("../firmware/43439A0_clm.bin");
